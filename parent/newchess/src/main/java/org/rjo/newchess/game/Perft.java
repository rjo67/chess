...
public class Perft {
   ...
   public static void main(String[] args) {
      ...
      System.out.println(String.format(Locale.GERMANY, "%dply: %,12d moves (%,9d ms) (%7.1f moves/ms) (%7.1f nanos/move)", REQD_DEPTH, moves, time,
    ...
    * @param  sideToMove the starting colour
    * @param  depth      the required depth to search
    * @return            a map containing all the start moves for the <code>sideToMove</code> and for each map entry, a
    ...
    * @param  sideToMove the starting colour
    * @param  depth      the required depth to search
    * @return            the list of possible moves at the given depth. The string representation is stored in order to
    *                    save memory.
    */
