...
public class PerftTest {
   ...
   public void test(String testname, String fenString, Colour sideToMove, int[] expectedNbrOfMoves) {
      ...
      for (int depth = 0; depth < Math.min(depthLimit, expectedNbrOfMoves.length); depth++) {
         if (expectedNbrOfMoves[depth] != -1) {
            ...
            System.out.println(String.format(Locale.GERMANY, "%40s %2dply: %,12d moves (%,8d ms) (%6.1f moves/ms)", testname, depth + 1, moves, time,
                  ((moves * 1.0) / time)));
   ...
   public static Collection<Object[]> data() {
      return Arrays.asList(new Object[][] {
            ...
            { "promotion www.rocechess.ch/perft.html", "n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - - 0 1", Colour.BLACK, new int[] { 24, 496, 9483, 182838, 3605103 // ,
                                                                                                                                                           // 71179139
            ...
            { "doubleCheckW", "8/5k2/8/5N2/5Q2/2K5/8/8 w - - 0 1", Colour.WHITE, new int[] { 37, 183, 6559, 23527 } },
