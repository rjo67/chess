...
public class PinnedPieceTest {
	...
	public void simplePin() {
		...
		TestUtil.checkMoves(new MoveGenerator2().findMoves(p, Colour.WHITE), "Ke2-d1", "Ke2-d3", "Ke2-e1", "Ke2-e3", "Ke2-f1", "Ke2-f2", "Ke2-f3");
	}
	...
	public void pinnedPieceCanMoveAlongRay() {
		...
		TestUtil.checkMoves(new MoveGenerator2().findMoves(p, Colour.WHITE), "Ke2-d1", "Ke2-d2", "Ke2-d3", "Ke2-e1", "Ke2-f1", "Ke2-f2", "Ke2-f3", "e3-e4");
