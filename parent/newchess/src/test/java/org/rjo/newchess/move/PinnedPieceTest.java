...
public class PinnedPieceTest {
   ...
   public void noPin() {
      ...
      TestUtil.checkMoves(p, new MoveGenerator(true).findMoves(p, Colour.WHITE), "Ke1-d1", "Ke1-d2", "Ke1-e2", "Ke1-f1", "Ke1-f2", "Re6-d6", "Re6-c6", "Re6-b6",
   ...
   public void simplePin() {
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), "Ke2-d1", "Ke2-d3", "Ke2-e1", "Ke2-e3", "Ke2-f1", "Ke2-f2", "Ke2-f3");
   }
   ...
   public void pinnedPieceCanMoveAlongRay() {
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), "Ke2-d1", "Ke2-d2", "Ke2-d3", "Ke2-e1", "Ke2-f1", "Ke2-f2", "Ke2-f3", "e3-e4");
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), "Ke2-d1", "Ke2-d2", "Ke2-e1", "Ke2-e3", "Ke2-f1", "Ke2-f2", "Ke2-f3", "b5-b6",
            "b5xa6", "Bd3xc4");
   }
   ...
   public void pinnedPieceCanMoveAlongOppositeRay() {
      ...
      p.addPiece(Colour.BLACK, Piece.ROOK, Square.e7);
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), "Ke2-d1", "Ke2-d2", "Ke2-d3", "Ke2-e1", "Ke2-e3", "Ke2-f1", "Ke2-f2", "Ke2-f3",
            // along pin ray
   ...
   public void pawnMoveAlongRay() {
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), "Ke1-d1", "Ke1-d2", "Ke1-f1", "Ke1-f2", "e2-e3", "e2-e4");
   }
   ...
   public void pinnedQueen() {
      ...
      TestUtil.checkMoves(game.getPosition(), new MoveGenerator(true).findMoves(game.getPosition(), Colour.WHITE), "Kf8-e8", "Kf8-g8", "Kf8-f7", "Kf8-g7",
            "Qe7-d6", "Qe7xc5", "Qf5-f6", "Qf5-f7+", "Qf5-f4", "Qf5-f3", "Qf5xf2+");
      var sw = StopWatch.createStarted();
      for (int i = 0; i < NBR_ITERS; i++) {
         List<IMove> moves = new MoveGenerator().findMoves(game.getPosition(), Colour.WHITE);
         assertEquals(11, moves.size(), "found moves: " + moves);
