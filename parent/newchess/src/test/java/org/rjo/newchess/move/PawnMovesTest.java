...
public class PawnMovesTest {
   ...
   public void pawnMovesWhiteNoCapture() {
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), TestUtil.PAWN_FILTER, "d5-d6");

      p = new Position(Square.e1, Square.e8);
      p.addPiece(Colour.WHITE, Piece.PAWN, Square.a2);
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), TestUtil.PAWN_FILTER, "a2-a3", "a2-a4");

      p = new Position(Square.e1, Square.e8);
      p.addPiece(Colour.WHITE, Piece.PAWN, Square.a2);
      p.addPiece(Colour.BLACK, Piece.PAWN, Square.a3);
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), TestUtil.PAWN_FILTER);
   }
   ...
   public void pawnMovesWhiteCapture() {
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), TestUtil.PAWN_FILTER, "d5-d6", "d5xc6");

      p = new Position(Square.e1, Square.e8);
      p.addPiece(Colour.WHITE, Piece.PAWN, Square.b2);
      p.addPiece(Colour.BLACK, Piece.PAWN, Square.a3);
      p.addPiece(Colour.BLACK, Piece.PAWN, Square.c3);
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), TestUtil.PAWN_FILTER, "b2-b3", "b2-b4", "b2xa3", "b2xc3");
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), TestUtil.PAWN_FILTER, "d4-d5", "c5-c6", "d4xe5");
   }
   ...
   public void pawnMovesBlackNoCapture() {
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.BLACK), TestUtil.PAWN_FILTER, "a7-a6", "a7-a5");

      p = new Position(Square.e1, Square.g6);
      p.addPiece(Colour.BLACK, Piece.PAWN, Square.d5);
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.BLACK), TestUtil.PAWN_FILTER, "d5-d4");

      p = new Position(Square.e1, Square.e8);
      p.addPiece(Colour.BLACK, Piece.PAWN, Square.a7);
      p.addPiece(Colour.WHITE, Piece.PAWN, Square.a6);
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.BLACK), TestUtil.PAWN_FILTER);
   }
   ...
   public void pawnMovesWhitePromotion() {
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), TestUtil.PAWN_FILTER, "d7-d8=R", "d7-d8=N", "d7-d8=B", "d7-d8=Q");
   ...
   public void pawnMovesBlackPromotion() {
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.BLACK), TestUtil.PAWN_FILTER, "d2-d1=R", "d2-d1=N", "d2-d1=B", "d2-d1=Q");
   ...
   public void pawnMovesWhiteEnPassant() {
      ...
      p.addPiece(Colour.WHITE, Piece.PAWN, Square.d5);
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.WHITE), TestUtil.PAWN_FILTER, "d5-d6", "d5xc6 ep");

      p = new Position(Square.e1, Square.e8);
      p.setEnpassantSquare(Square.f6);
      p.addPiece(Colour.WHITE, Piece.PAWN, Square.e5);
      p.addPiece(Colour.WHITE, Piece.PAWN, Square.g5);
      TestUtil.checkMoves(p, new MoveGenerator(false).findMoves(p, Colour.WHITE), TestUtil.PAWN_FILTER, "e5-e6", "e5xf6 ep", "g5-g6", "g5xf6 ep");
   }
   ...
   public void pawnMovesBlackEnPassant() {
      ...
      p.addPiece(Colour.WHITE, Piece.PAWN, Square.c4);
      p.addPiece(Colour.BLACK, Piece.PAWN, Square.d4);
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.BLACK), TestUtil.PAWN_FILTER, "d4-d3", "d4xc3 ep");

      p = new Position(Square.e1, Square.e8);
      p.setEnpassantSquare(Square.f3);
      p.addPiece(Colour.BLACK, Piece.PAWN, Square.e4);
      p.addPiece(Colour.BLACK, Piece.PAWN, Square.g4);
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.BLACK), TestUtil.PAWN_FILTER, "e4-e3", "e4xf3 ep", "g4-g3", "g4xf3 ep");
   }
   ...
   public void enpassantPossibleButPawnPinned() {
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.BLACK), "Kh4-g5", "Kh4xg4", "Kh4-g3", "Kh4-h3", "Rh5-h6", "Rh5-h7", "Rh5-h8", "Rh5-g5",
   ...
   public void enpassantPossibleButPawnPinned2() {
      ...
      TestUtil.checkMoves(p, new MoveGenerator().findMoves(p, Colour.BLACK), "Kh4-g5", "Kh4-g4", "Kh4-g3", "Rh5-h6", "Rh5-h7", "Rh5-h8", "Rh5-g5", "Rh5-f5",
