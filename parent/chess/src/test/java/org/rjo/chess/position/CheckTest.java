...
public class CheckTest {
	...
	public void checkRook() {
		...
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), "Kc6-b7", "Kc6-d5", "Nd7-c5", "Nb2xc4", "Re5-c5", "Rf4xc4", "Qd3xc4",
				"Qe3-c5", "Ba3-c5", "Be6xc4", "b5xc4");
	}

	@Test
	public void checkPromotion() {
		Game game = Fen.decode("r4K2/1PB1Q3/2N5/8/6k1/8/8/R2R4 w - - 0 4");
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.WHITE), "Kf8-f7", "Kf8-g7", "Nc6-b8", "Nc6-d8", "Bc7-b8", "Bc7-d8", "Ra1xa8",
				"Rd1-d8", "Qe7-d8", "Qe7-e8", "b7xa8=R", "b7xa8=N", "b7xa8=B", "b7xa8=Q", "b7-b8=Q", "b7-b8=R", "b7-b8=B", "b7-b8=N");
	}
	...
	public void pin() {
		...
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), "a7-a6", "b7-b6", "c7-c6", "d7-d6", "e7-e6", "g7-g6", "a7-a5",
				"b7-b5", "c7-c5", "d7-d5", "e7-e5", "g7-g5", "Rh8-h7", "Rh8-h6", "Rh8xh5", "Nb8-a6", "Nb8-c6", "Ng8-f6", "Ng8-h6");
	}
