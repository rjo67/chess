 ...
 * walk the move generation tree of strictly legal moves to count all the leaf
 * nodes of a certain depth. PERFT tests are usually pretty slow, therefore the
 ...
 * </pre>
 * <p>
 * <h1>Debugging tips</h1> If the Perft does not return the correct number of
 * moves, one way of attacking the problem is to use the excellent "JetChess" to
 * calculate the perft scores. Then see which move(s) return the wrong number of
...
public class PerftTest {
	...
	/**
	 * performs perft(n) for n = 1..size of expectedNbrOfMoves. Fill
	 * expectedNbrOfMoves with -1 to avoid calling for this depth.
	 */
	@ParameterizedTest
	@MethodSource("data")
	public void test(String testname, String fenString, Colour sideToMove, int[] expectedNbrOfMoves) {
		for (int depth = 0; depth < expectedNbrOfMoves.length; depth++) {
			if (expectedNbrOfMoves[depth] != -1) {
				...
				System.out.println(String.format(Locale.GERMANY, "%40s %2dply: %,12d moves (%,8d ms) (%6.1f moves/ms)",
	 ...
	 * <li>expected number of moves for each depth (-1 means do not perform search
	 * at this depth) -- int[]</li>
	 * </ul>
	 */
	public static Collection<Object[]> data() {
		...
		return Arrays.asList(new Object[][] {
				...
				{ "posn5", "rnbqkb1r/pp1p1ppp/2p5/4P3/2B5/8/PPP1NnPP/RNBQK2R w KQkq - 0 6", Colour.WHITE,
				...
				{ "illegalEpMove1W", "8/8/8/8/k1p4R/8/3P4/3K4 w - - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, -1, -1, 1134888 } },
				{ "illegalEpMove1B", "3k4/3p4/8/K1P4r/8/8/8/8 b - - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, -1, -1, 1134888 } },
				{ "illegalEpMove2W", "8/8/4k3/8/2p5/8/B2P2K1/8 w - - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, -1, -1, 1015133 } },
				{ "illegalEpMove2B", "8/b2p2k1/8/2P5/8/4K3/8/8 b - - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, -1, -1, 1015133 } },
				{ "epCaptureChecksOpponentW", "8/5k2/8/2Pp4/2B5/1K6/8/8 w - d6 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, -1, -1, 1440467 } },
				{ "epCaptureChecksOpponentB", "8/8/1k6/2b5/2pP4/8/5K2/8 b - d3 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, -1, -1, 1440467 } },
				{ "shortCastlingChecksOpponentW", "5k2/8/8/8/8/8/8/4K2R w K - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, -1, -1, 661072 } },
				{ "shortCastlingChecksOpponentB", "4k2r/8/8/8/8/8/8/5K2 b k - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, -1, -1, 661072 } },
				{ "longCastlingChecksOpponentW", "3k4/8/8/8/8/8/8/R3K3 w Q - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, -1, -1, 803711 } },
				{ "longCastlingChecksOpponentB", "r3k3/8/8/8/8/8/8/3K4 b q - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, -1, -1, 803711 } },
				{ "castlingIncludingLosingOrRookCaptureW", "r3k2r/1b4bq/8/8/8/8/7B/R3K2R w KQkq - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, 1274206 } },
				{ "castlingIncludingLosingOrRookCaptureB", "r3k2r/7b/8/8/8/8/1B4BQ/R3K2R b KQkq - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, 1274206 } },
				{ "castlingPreventedW", "r3k2r/8/5Q2/8/8/3q4/8/R3K2R w KQkq - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, 1720476 } },
				{ "castlingPreventedB", "r3k2r/8/3Q4/8/8/5q2/8/R3K2R b KQkq - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, 1720476 } },
				{ "promoteOutOfCheckW", "2K2r2/4P3/8/8/8/8/8/3k4 w - - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, -1, -1, 3821001 } },
				{ "promoteOutOfCheckB", "3K4/8/8/8/8/8/4p3/2k2R2 b - - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, -1, -1, 3821001 } },
				{ "discoveredCheck", "8/8/8/2k3PR/8/1p2K3/2P2B2/2Q5 w - - 0 10", Colour.WHITE, new int[] { 31 } },
				{ "discoveredCheck2W", "5K2/8/1Q6/2N5/8/1p2k3/8/8 w - - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, -1, 1004658 } },
				{ "discoveredCheck2B", "8/8/1P2K3/8/2n5/1q6/8/5k2 b - - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, -1, 1004658 } },
				{ "selfStalemateCheckmate", "8/k1P5/8/1K6/8/8/8/8 w - - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, -1, -1, -1, 567584 } },
				{ "selfStalemateCheckmate2", "8/8/8/8/1k6/8/K1p5/8 b - - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, -1, -1, -1, 567584 } },
				{ "selfStalemateW", "K1k5/8/P7/8/8/8/8/8 w - - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, -1, -1, 2217 } },
				{ "selfStalemateB", "8/8/8/8/8/p7/8/k1K5 b - - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, -1, -1, 2217 } },
				...
				{ "promoteToGiveCheckW", "4k3/1P6/8/8/8/8/K7/8 w - - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, -1, -1, 217342 } },
				{ "promoteToGiveCheckB", "8/k7/8/8/8/8/1p6/4K3 b - - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, -1, -1, 217342 } },
				{ "underpromoteToGiveCheckW", "8/P1k5/K7/8/8/8/8/8 w - - 0 1", Colour.WHITE,
						new int[] { -1, -1, -1, -1, -1, 92683 } },
				{ "underpromoteToGiveCheckB", "8/8/8/8/8/k7/p1K5/8 b - - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, -1, -1, 92683 } },
				{ "doubleCheckW", "8/5k2/8/5N2/5Q2/2K5/8/8 w - - 0 1", Colour.WHITE, new int[] { -1, -1, -1, 23527 } },
				{ "doubleCheckB", "8/8/2k5/5q2/5n2/8/5K2/8 b - - 0 1", Colour.BLACK,
						new int[] { -1, -1, -1, 23527 } } });
		// @formatter:on
	}
