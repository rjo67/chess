...
public class BlackPawnTest {
	...
	public void blockedPawn() {
		...
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "a6-a5");
	}

	@Test
	public void captureLeft() {
		setupGame("4k3/8/8/1p6/PP6/8/8/4K3 b - - 0 0");
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "b5xa4");
	}

	@Test
	public void captureLeftPromotion() {
		setupGame("4k3/8/8/8/8/8/1p6/RK6 b - - 0 0");
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "b2xa1=R+", "b2xa1=N", "b2xa1=B", "b2xa1=Q+");
	}

	@Test
	public void captureRight() {
		setupGame("4k3/8/8/8/p7/PP6/8/4K3 b - - 0 0");
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "a4xb3");
	}

	@Test
	public void captureRightPromotion() {
		setupGame("4k3/8/8/8/8/8/2p5/2KR4 b - - 0 0");
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "c2xd1=R+", "c2xd1=N", "c2xd1=B", "c2xd1=Q+");
	}

	@Test
	public void promotion() {
		setupGame("4k3/8/8/8/8/8/p7/4K3 b - - 0 0");
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "a2-a1=Q+", "a2-a1=B", "a2-a1=N", "a2-a1=R+");
	}

	@Test
	public void promotionRoce() {
		setupGame("n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - - 0 1");
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), "g2-g1=R", "g2-g1=N+", "g2-g1=B", "g2-g1=Q", "g2xf1=R", "g2xf1=N",
	...
	public void enpassantRight() {
		...
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "a4-a3", "a4xb3");
	}

	@Test
	public void enpassantLeft() {
		setupGame("4k3/8/8/8/Pp6/8/8/4K3 b - a3 0 0");
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "b4-b3", "b4xa3");
	}

	@Test
	public void enpassantWithTwoCandidatePawns() {
		setupGame("4k3/8/8/8/1pPp4/8/8/4K3 b - c3 0 0");
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "b4-b3", "b4xc3", "d4-d3", "d4xc3");
	}

	@Test
	public void checkLeft() {
		setupGame("4k3/8/8/3p4/8/2K5/8/8 b - - 0 0");
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "d5-d4+");
	}
	...
	public void checkCaptureLeft() {
		...
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "d5-d4", "d5xc4+");
	}

	@Test
	public void checkCaptureRight() {
		setupGame("4k3/8/8/3p4/3PP3/5K2/8/8 b - - 0 0");
		TestUtil.checkMoves(game.getPosition().findMoves(Colour.BLACK), TestUtil.KING_FILTER, "d5xe4+");
	}
