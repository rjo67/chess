...
public class PositionTest {
	...
	public void posn3() {
		...
		assertEquals("found moves" + moveMap, 35, nbrMoves);
	}
	...
	public void discoveredCheck() {
		...
		assertTrue(Position.discoveredCheck(Colour.BLACK, game.getPosition(), emptySquares, myPieces, Square.e1, Square.e4));
	}
	...
	public void discoveredCheck2() {
		...
		assertTrue(Position.discoveredCheck(Colour.WHITE, game.getPosition(), emptySquares, myPieces, Square.e8, Square.b5));
	}
	...
	public void noDiscoveredCheck() {
		...
		BitSetUnifier myPieces = game.getPosition().getAllPieces(Colour.BLACK).getBitSet();
		myPieces.clear(Square.e4.bitIndex());
		assertFalse(Position.discoveredCheck(Colour.BLACK, game.getPosition(), emptySquares, myPieces, Square.e1, Square.e4));
	}
