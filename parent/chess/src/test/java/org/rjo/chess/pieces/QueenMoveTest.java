...
public class QueenMoveTest extends AbstractMoveTest {
	...
	public void moveFromMiddleOfBoard() {
		...
		TestUtil.checkMoves(findQueenMoves(), "Qd4-d5", "Qd4-d6", "Qd4-d7+", "Qd4-d8+",
	...
	public void moveFromA1() {
		...
		TestUtil.checkMoves(findQueenMoves(), "Qa1-a2", "Qa1-a3", "Qa1-a4+", "Qa1-a5",
	...
	public void moveFromA1WithCapture() {
		...
		TestUtil.checkMoves(findQueenMoves(), "Qa1-a2", "Qa1-a3", "Qa1xa4+", "Qa1-b1", "Qa1-b2", "Qa1-c3", "Qa1-d4", "Qa1xe5+");
	}

	@Test
	public void moveFromA8() {
		setupGame("Q7/8/8/2k5/8/8/2K5/8  w - - 0 0");
		TestUtil.checkMoves(findQueenMoves(), "Qa8-a7+", "Qa8-a6", "Qa8-a5+", "Qa8-a4",
