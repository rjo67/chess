...
public final class LuceneBitSet implements BitSetUnifier, Cloneable {
   ...
   public boolean equals(Object o) {
      ...
      if (!(o instanceof LuceneBitSet)) { return false; }
   ...
   @Override
   public boolean isEmpty() { return bs.scanIsEmpty(); }
   ...
   public int nextSetBit(int fromIndex) {
      ...
      if (nextBit == DocIdSetIterator.NO_MORE_DOCS) { return -1; }
      return nextBit;
   }
   ...
   /*
    * private void iterator(int from) { int start = from; return new IteratorImpl(this, start, false); }
    */
