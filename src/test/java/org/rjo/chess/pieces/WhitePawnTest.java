...
public class WhitePawnTest {
	...
	public void startPosition() {
		...
		TestUtil.checkMoves(findMoves(game.getPosition()), "a2-a3", "a2-a4", "b2-b3", "b2-b4", "c2-c3", "c2-c4", "d2-d3", "d2-d4", "e2-e3",
				"e2-e4", "f2-f3", "f2-f4", "g2-g3", "g2-g4", "h2-h3", "h2-h4");
	}

	@Test
	public void blockedPawn() {
		setupGame("4k3/8/8/8/8/P7/P7/4K3 w - - 0 0");
		TestUtil.checkMoves(findMoves(game.getPosition()), "a3-a4");
	}

	@Test
	public void captureLeft() {
		setupGame("4k3/8/8/8/8/pp6/1P6/4K3 w - - 0 0");
		TestUtil.checkMoves(findMoves(game.getPosition()), "b2xa3");
	}

	@Test
	public void captureLeftPromotion() {
		setupGame("rk6/1P6/8/8/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(findMoves(game.getPosition()), "b7xa8=R+", "b7xa8=N", "b7xa8=B", "b7xa8=Q+");
	}

	@Test
	public void captureRight() {
		setupGame("4k3/8/8/8/8/pp6/P7/4K3 w - - 0 0");
		TestUtil.checkMoves(findMoves(game.getPosition()), "a2xb3");
	}

	@Test
	public void captureRightPromotion() {
		setupGame("kr6/P7/8/8/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(findMoves(game.getPosition()), "a7xb8=R+", "a7xb8=N", "a7xb8=B", "a7xb8=Q+");
	}

	@Test
	public void promotionCheckKnight() {
		setupGame("8/4k1P1/8/8/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(findMoves(game.getPosition()), "g7-g8=Q", "g7-g8=B", "g7-g8=N+", "g7-g8=R");
	}
	...
	public void enpassantRight() {
		...
		TestUtil.checkMoves(findMoves(game.getPosition()), "a5-a6", "a5xb6");
	}

	@Test
	public void enpassantLeft() {
		setupGame("4k3/8/8/pP6/8/8/8/4K3 w - a6 0 0");
		TestUtil.checkMoves(findMoves(game.getPosition()), "b5-b6", "b5xa6");
	}

	@Test
	public void enpassantWithTwoCandidatePawns() {
		setupGame("4k3/8/8/1PpP4/8/8/8/4K3 w - c6 0 0");
		TestUtil.checkMoves(findMoves(game.getPosition()), "b5-b6", "b5xc6", "d5-d6", "d5xc6");
	}

	@Test
	public void checkRight() {
		setupGame("8/4k3/8/3P4/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(findMoves(game.getPosition()), "d5-d6+");
	}
	...
	public void checkCaptureLeft() {
		...
		TestUtil.checkMoves(findMoves(game.getPosition()), "d5-d6", "d5xc6+");
	}

	@Test
	public void checkCaptureRight() {
		setupGame("8/5k2/3pp3/3P4/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(findMoves(game.getPosition()), "d5xe6+");
	}
