...
public class WhitePawnTest {
	...
	public void startPosition() {
		...
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "a2-a3", "a2-a4", "b2-b3", "b2-b4", "c2-c3", "c2-c4",
	...
	public void blockedPawn() {
		...
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "a3-a4");
	}

	@Test
	public void captureLeft() {
		setupGame("4k3/8/8/8/8/pp6/1P6/4K3 w - - 0 0");
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "b2xa3");
	}

	@Test
	public void captureLeftPromotion() {
		setupGame("rk6/1P6/8/8/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "b7xa8=R+", "b7xa8=N", "b7xa8=B", "b7xa8=Q+");
	}

	@Test
	public void captureRight() {
		setupGame("4k3/8/8/8/8/pp6/P7/4K3 w - - 0 0");
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "a2xb3");
	}

	@Test
	public void captureRightPromotion() {
		setupGame("kr6/P7/8/8/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "a7xb8=R+", "a7xb8=N", "a7xb8=B", "a7xb8=Q+");
	}

	@Test
	public void promotionCheckKnight() {
		setupGame("8/4k1P1/8/8/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "g7-g8=Q", "g7-g8=B", "g7-g8=N+", "g7-g8=R");
	}
	...
	public void enpassantRight() {
		...
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "a5-a6", "a5xb6");
	}
	...
	public void enpassantLeft() {
		...
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "b5-b6", "b5xa6");
	}
	...
	public void enpassantWithTwoCandidatePawns() {
		...
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "b5-b6", "b5xc6", "d5-d6", "d5xc6");
	}

	@Test
	public void checkRight() {
		setupGame("8/4k3/8/3P4/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "d5-d6+");
	}
	...
	public void checkCaptureLeft() {
		...
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "d5-d6", "d5xc6+");
	}

	@Test
	public void checkCaptureRight() {
		setupGame("8/5k2/3pp3/3P4/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(pawn.findMoves(game.getPosition()), "d5xe6+");
	}
