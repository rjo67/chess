...
public class KnightMoveTest {
	...
	public void startPosition() {
		...
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Nb1-a3", "Nb1-c3", "Ng1-f3", "Ng1-h3");
	}

	@Test
	public void moveFromMiddleOfBoard() {
		setupGame("4k3/8/8/8/3N4/5p2/8/4K3 w - - 0 0");
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Nd4-e6", "Nd4-f5", "Nd4xf3", "Nd4-e2",
	...
	public void moveFromA1() {
		...
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Na1-b3", "Na1-c2");
	}
	...
	public void moveFromA1WithBlockade() {
		...
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Na1-b3");
	}
	...
	public void moveFromA1WithCapture() {
		...
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Na1-b3", "Na1xc2");
	}

	@Test
	public void moveFromH1() {
		setupGame("4k3/8/8/8/8/8/8/4K2N w - - 0 0");
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Nh1-g3", "Nh1-f2");
	}
	...
	public void moveFromH1WithBlockade() {
		...
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Nh1-g3");
	}
	...
	public void moveFromH1WithCapture() {
		...
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Nh1xg3");
	}

	@Test
	public void moveFromA8() {
		setupGame("N3k3/8/8/8/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Na8-b6", "Na8-c7+");
	}
	...
	public void moveFromA8WithBlockade() {
		...
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Na8-b6");
	}
	...
	public void moveFromA8WithCapture() {
		...
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Na8-b6", "Na8xc7+");
	}

	@Test
	public void moveFromH8() {
		setupGame("4k2N/8/8/8/8/8/8/4K3 w - - 0 0");
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Nh8-g6", "Nh8-f7");
	}
	...
	public void moveFromH8WithBlockade() {
		...
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Nh8-g6");
	}
	...
	public void moveFromH8WithCapture() {
		...
		TestUtil.checkMoves(whiteKnight.findMoves(game.getChessboard()), "Nh8-g6", "Nh8xf7");
	}
