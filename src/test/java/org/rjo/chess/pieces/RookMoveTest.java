...
public class RookMoveTest {
	...
	private List<Move> findMoves(Position posn) {
		...
		for (Move move : moves) {
			move.setCheck(whiteRook.isOpponentsKingInCheckAfterMove(posn, move, opponentsKing, emptySquares, discoveredCheckCache));
		}
		return moves;
	}
	...
	public void moveFromMiddleOfBoard() {
		...
		TestUtil.checkMoves(findMoves(game.getPosition()), "Rd4-d5", "Rd4-d6", "Rd4-d7", "Rd4-d8+", "Rd4-e4+", "Rd4-f4", "Rd4-g4", "Rd4-h4",
	...
	public void moveFromA1() {
		...
		TestUtil.checkMoves(findMoves(game.getPosition()), "Ra1-a2", "Ra1-a3", "Ra1-a4", "Ra1-a5", "Ra1-a6", "Ra1-a7", "Ra1-a8+", "Ra1-b1",
	...
	public void moveFromH1() {
		...
		TestUtil.checkMoves(findMoves(game.getPosition()), "Rh1-h2", "Rh1-h3", "Rh1-h4", "Rh1-h5", "Rh1-h6", "Rh1-h7", "Rh1-h8+", "Rh1-g1",
	...
	public void moveFromA8() {
		...
		TestUtil.checkMoves(findMoves(game.getPosition()), "Ra8-a7", "Ra8-a6", "Ra8-a5+", "Ra8-a4", "Ra8-a3", "Ra8-a2", "Ra8-a1", "Ra8-b8+",
	...
	public void moveFromH8() {
		...
		TestUtil.checkMoves(findMoves(game.getPosition()), "Rh8-h7", "Rh8-h6", "Rh8-h5+", "Rh8-h4", "Rh8-h3", "Rh8-h2", "Rh8-h1", "Rh8-g8",
