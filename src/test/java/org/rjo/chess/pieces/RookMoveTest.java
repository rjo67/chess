...
public class RookMoveTest {
	...
	public void moveFromA1() {
		...
		TestUtil.checkMoves(whiteRook.findMoves(game.getPosition()), "Ra1-a2", "Ra1-a3", "Ra1-a4", "Ra1-a5", "Ra1-a6",
	...
	public void moveFromA1WithBlockade() {
		...
		TestUtil.checkMoves(whiteRook.findMoves(game.getPosition()), "Ra1-a2", "Ra1-a3", "Ra1-b1");
	}
	...
	public void moveFromA1WithCapture() {
		setupGame("4k3/8/8/8/p7/8/8/R1K5 w - - 0 0");
		TestUtil.checkMoves(whiteRook.findMoves(game.getPosition()), "Ra1-a2", "Ra1-a3", "Ra1xa4", "Ra1-b1");
	}

	@Test
	public void moveFromH1() {
		setupGame("4k3/1K6/8/8/8/8/8/7R w - - 0 0");
		TestUtil.checkMoves(whiteRook.findMoves(game.getPosition()), "Rh1-h2", "Rh1-h3", "Rh1-h4", "Rh1-h5", "Rh1-h6",
	...
	public void moveFromH1WithBlockade() {
		...
		TestUtil.checkMoves(whiteRook.findMoves(game.getPosition()), "Rh1-h2", "Rh1-h3", "Rh1-g1");
	}
	...
	public void moveFromH1WithCapture() {
		setupGame("4k3/8/8/8/7p/8/8/5K1R w - - 0 0");
		TestUtil.checkMoves(whiteRook.findMoves(game.getPosition()), "Rh1-h2", "Rh1-h3", "Rh1xh4", "Rh1-g1");
	}
	...
	public void moveFromA8WithBlockade() {
		...
		TestUtil.checkMoves(whiteRook.findMoves(game.getPosition()), "Ra8-a7", "Ra8-a6", "Ra8-b8");
	}
	...
	public void moveFromA8WithCapture() {
		...
		TestUtil.checkMoves(whiteRook.findMoves(game.getPosition()), "Ra8-a7", "Ra8-a6", "Ra8xa5", "Ra8-b8");
	}
	...
	public void moveFromH8WithBlockade() {
		...
		TestUtil.checkMoves(whiteRook.findMoves(game.getPosition()), "Rh8-h7", "Rh8-h6", "Rh8-g8+");
	}
	...
	public void moveFromH8WithCapture() {
		setupGame("5K1R/8/8/6kp/8/8/8/8 w - - 0 0");
		TestUtil.checkMoves(whiteRook.findMoves(game.getPosition()), "Rh8-h7", "Rh8-h6", "Rh8xh5+", "Rh8-g8+");
	}
