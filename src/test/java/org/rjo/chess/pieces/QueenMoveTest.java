...
public class QueenMoveTest {
	...
	private void setupGame(String fen) {
		game = Fen.decode(fen);
		whiteQueen = game.getPosition().getPieces(Colour.WHITE).get(PieceType.QUEEN);
	}
	...
	public void startPosition() {
		...
		TestUtil.checkMoves(whiteQueen.findMoves(game.getPosition()), new HashSet<>());
	}

	@Test
	public void moveFromMiddleOfBoard() {
		setupGame("4k3/8/8/8/3Q4/8/8/4K3  w - - 0 0");
		TestUtil.checkMoves(whiteQueen.findMoves(game.getPosition()), "Qd4-d5", "Qd4-d6", "Qd4-d7+", "Qd4-d8+",
	...
	public void moveFromA1() {
		...
		TestUtil.checkMoves(whiteQueen.findMoves(game.getPosition()), "Qa1-a2", "Qa1-a3", "Qa1-a4+", "Qa1-a5",
	...
	public void moveFromA1WithCapture() {
		...
		TestUtil.checkMoves(whiteQueen.findMoves(game.getPosition()), "Qa1-a2", "Qa1-a3", "Qa1xa4+", "Qa1-b1",
	...
	public void moveFromA8() {
		...
		TestUtil.checkMoves(whiteQueen.findMoves(game.getPosition()), "Qa8-a7+", "Qa8-a6", "Qa8-a5+", "Qa8-a4",
	...
	public void moveFromA8WithCapture() {
		...
		TestUtil.checkMoves(whiteQueen.findMoves(game.getPosition()), "Qa8-a7+", "Qa8-a6", "Qa8xa5+", "Qa8-b8",
	...
	public void attacksSquareStraight() {
		...
		for (Square sq : new Square[] { Square.e8, Square.e6, Square.d7, Square.c7, Square.b7, Square.a7, Square.f7,
			...
			assertTrue("square " + sq,
					whiteQueen.attacksSquare(game.getPosition().getEmptySquares().getBitSet(), sq));
		}
