 ...
 * nodes of a certain depth.
 *
 * PERFT tests are usually pretty slow, therefore the majority of tests do not
 * run automatically.
 *
 * <p>
 * Results 08.04.2015:
...
public class PerftTest {
	...
	/**
	 * Use this to run all the long-running PERFT tests (see
	 * {@link #allTests()}.
	 * <ul>
	...
	public static void main(String[] args) {
		...
		System.out.println(
				String.format(Locale.GERMANY, "Finished in %,6d s", (System.currentTimeMillis() - start) / 1000));
	}
	...
	private void doTest(String testname, String fenString, Colour sideToMove, int[] expectedNbrOfMoves,
		...
		for (int depth = 0; depth < expectedNbrOfMoves.length; depth++) {
			if (expectedNbrOfMoves[depth] != -1) {
				...
				if (printout) {
					System.out.println(
							String.format(Locale.GERMANY, "%40s %2dply: %,12d moves (%,9d ms) (%7.1f moves/ms)",
	...
	private Object[][] data = new Object[][] {
			...
			{ "promotion www.rocechess.ch/perft.html", "n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - - 0 1", Colour.BLACK,
					new int[] { -1, -1, -1, -1, 3605103 /* , 71179139 */ } },
	...
	/**
	 * various discovered checks. Pawn move - discovered check from rook. King
	 * move - discovered check from bishop. Pawn capture - discovered check from
	 * queen.
	 */
	@Test
