...
public class GameTest {
	...
	public void kingsCastlingWhite() {
		...
		assertFalse(game.getChessboard().canCastle(Colour.WHITE, CastlingRights.KINGS_SIDE));
	}
	...
	public void kingsCastlingBlack() {
		...
		assertFalse(game.getChessboard().canCastle(Colour.BLACK, CastlingRights.KINGS_SIDE));
	}
	...
	public void queensCastlingWhite() {
		...
		assertFalse(game.getChessboard().canCastle(Colour.WHITE, CastlingRights.QUEENS_SIDE));
	}
	...
	public void queensCastlingBlack() {
		...
		assertFalse(game.getChessboard().canCastle(Colour.BLACK, CastlingRights.QUEENS_SIDE));
	}
	...
	public void unmoveKingsCastlingWhite() {
		...
		assertTrue(game.getChessboard().canCastle(Colour.WHITE, CastlingRights.KINGS_SIDE));
	}
	...
	public void unmoveKingsCastlingBlack() {
		...
		assertTrue(game.getChessboard().canCastle(Colour.BLACK, CastlingRights.KINGS_SIDE));
	}
	...
	public void unmoveQueensCastlingWhite() {
		...
		assertPieceAt(cb, Square.e1, PieceType.KING);
		assertTrue(game.getChessboard().canCastle(Colour.WHITE, CastlingRights.QUEENS_SIDE));
	}
	...
	public void unmoveQueensCastlingBlack() {
		...
		assertPieceAt(cb, Square.e8, PieceType.KING);
		assertTrue(game.getChessboard().canCastle(Colour.BLACK, CastlingRights.QUEENS_SIDE));
	}
	...
	public void eval() {
		...
		System.out.println(game.getChessboard().evaluate());
