...
public class MoveDistance {
	 ...
	 * 15x15. (This is the square with value 0.) http://chessprogramming.wikispaces.com/Distance
	 */
	...
	/**
	 * Returns the 'Chebyshev distance' (the minimal number of king moves between two squares on the otherwise empty board).
	 * 
	 * @param start start square
	 * @param finish finish square
	 * @return the distance between the two squares (0..7).
	 */
	public static int calculateDistance(Square start,
			Square finish) {
