...
/**
 * Attempts to optimize the test whether a king is in check, by storing data structures which don't
 * change.
 *
 * @author rich
 */
public class KingChecker {
	...
	private Map<PieceType, BitSet> setupEnemyBitsets(Piece[] pieces) {
		Map<PieceType, BitSet> enemyPieces = new HashMap<>(); // TODO change to array
