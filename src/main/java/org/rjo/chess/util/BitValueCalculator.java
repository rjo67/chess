...
/**
 * Calculates HI and LO values for 8-bit values, where the nth bit is set.
 * e.g. for the 4th bit, HI will be the values of bits 4 to 8, LO will be 1 to 3.
 *
 * @author rich
 */
public class BitValueCalculator {
   ...
   private static int[] MASKS = { 0b00000000, 0b00000001, 0b00000011, 0b00000111, 0b00001111, 0b00011111, 0b00111111,
         0b01111111, };
   ...
   private static void postProcess(int piecePosn, Set<Integer> cache) {
      /*
       * post process HI nibbles (going left from bit 0):
       * remove instances where the next bit is set (since these are all the same from our POV)
       * eg. 00011 and 01011 are the same, since bit 1 is set in both
       */
