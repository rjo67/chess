...
public class QueenMoveTest {
   ...
   public void startPosition() {
      ...
      TestUtil.checkMoves(whiteQueen.findMoves(chessboard), new HashSet<>());
   }
   ...
   public void moveFromMiddleOfBoard() {
      ...
      TestUtil.checkMoves(
            whiteQueen.findMoves(chessboard),
            new HashSet<>(Arrays.asList("Qd4-d5", "Qd4-d6", "Qd4-d7", "Qd4-d8", "Qd4-e4", "Qd4-f4", "Qd4-g4", "Qd4-h4",
                  "Qd4-d3", "Qd4-d2", "Qd4-d1", "Qd4-c4", "Qd4-b4", "Qd4-a4", "Qd4-e5", "Qd4-f6", "Qd4-g7", "Qd4-h8",
                  "Qd4-c5", "Qd4-b6", "Qd4-a7", "Qd4-e3", "Qd4-f2", "Qd4-g1", "Qd4-c3", "Qd4-b2", "Qd4-a1")));
   }
   ...
   public void moveFromA1() {
      ...
      TestUtil.checkMoves(
            whiteQueen.findMoves(chessboard),
            new HashSet<>(Arrays.asList("Qa1-a2", "Qa1-a3", "Qa1-a4", "Qa1-a5", "Qa1-a6", "Qa1-a7", "Qa1-a8", "Qa1-b1",
                  "Qa1-c1", "Qa1-d1", "Qa1-e1", "Qa1-f1", "Qa1-g1", "Qa1-h1", "Qa1-b2", "Qa1-c3", "Qa1-d4", "Qa1-e5",
                  "Qa1-f6", "Qa1-g7", "Qa1-h8")));
   }
   ...
   public void moveFromA1WithBlockade() {
      ...
      Chessboard chessboard = new Chessboard(whitePieces, new HashSet<>());
      TestUtil.checkMoves(whiteQueen.findMoves(chessboard),
   ...
   public void moveFromA8() {
      ...
      TestUtil.checkMoves(
            whiteQueen.findMoves(chessboard),
            new HashSet<>(Arrays.asList("Qa8-a7", "Qa8-a6", "Qa8-a5", "Qa8-a4", "Qa8-a3", "Qa8-a2", "Qa8-a1", "Qa8-b8",
                  "Qa8-c8", "Qa8-d8", "Qa8-e8", "Qa8-f8", "Qa8-g8", "Qa8-h8", "Qa8-b7", "Qa8-c6", "Qa8-d5", "Qa8-e4",
                  "Qa8-f3", "Qa8-g2", "Qa8-h1")));
   }
