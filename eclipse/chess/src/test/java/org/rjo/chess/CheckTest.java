...
public class CheckTest {
   ...
   public void checkRook() {
      ...
      TestUtil.checkMoves(
            game.findMoves(Colour.BLACK),
            new HashSet<>(Arrays.asList("Kc6-b7", "Kc6-d5", "Nd7-c5", "Nb2xc4", "Re5-c5", "Rf4xc4", "Qd3xc4", "Qe3-c5",
                  "Ba3-c5", "Be6xc4", "b5xc4")));
   }
   ...
   public void doubleCheck() {
      ...
      game.setInCheck(true);
      TestUtil.checkMoves(game.findMoves(Colour.WHITE), new HashSet<>(Arrays.asList("Kf7-e8", "Kf7-f6", "Kf7-g6")));
   }
   ...
   public void pin() {
      ...
      TestUtil.checkMoves(
            game.findMoves(Colour.BLACK),
            new HashSet<>(Arrays.asList("a7-a6", "b7-b6", "c7-c6", "d7-d6", "e7-e6", "g7-g6", "a7-a5", "b7-b5",
                  "c7-c5", "d7-d5", "e7-e5", "g7-g5", "Rh8-h7", "Rh8-h6", "Rh8xh5", "Nb8-a6", "Nb8-c6", "Ng8-f6",
                  "Ng8-h6")));
   }
   ...
   public void checkmate() {
      ...
      game.setInCheck(true);
      TestUtil.checkMoves(game.findMoves(Colour.WHITE), new HashSet<>(Arrays.asList()));
   }
   ...
   public void saragossaOpening() {
      ...
      game.setInCheck(true);
      TestUtil.checkMoves(game.findMoves(Colour.BLACK),
            new HashSet<>(Arrays.asList("b7-b5", "c7-c6", "Nb8-c6", "Nb8-d7", "Bc8-d7", "Qd8-d7")));
   }
}
